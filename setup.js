...
db.serialize(function(){
  db.run("CREATE TABLE IF NOT EXISTS Contacts (id INTEGER PRIMARY KEY AUTOINCREMENT, name varchar(20), company TEXT, telp_number varchar(20), email varchar(20) )");
  db.run(`INSERT INTO Contacts (id,name,company,telp_number,email)
          VALUES(1,"Ferdy","hacktiv8","0812345678","ferdy@gmail.com")`)
